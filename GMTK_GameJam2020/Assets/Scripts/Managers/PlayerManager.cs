    ...
    public class PlayerManager : MonoBehaviour
    {
        ...
        void Scan()
        {
            ...
            if (selectedEntry.CoreElement.Result == ScanResult.License)
            {
                ...
                GameManager.ComputerManager.AddToEventLog("Found license upgrade!", new Color(0.1f, 0.5f, 0f));
            }
            else if (selectedEntry.CoreElement.Result == ScanResult.PasswordLetter)
            {
                ...
                GameManager.ComputerManager.AddToEventLog("Found password letter!", new Color(0.1f, 0.5f, 0f));
